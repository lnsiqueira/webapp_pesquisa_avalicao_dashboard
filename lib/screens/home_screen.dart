...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // }
  String textoAvaliacao(int nota) {
    switch (nota) {
      case 1:
        return 'Regular';
      case 2:
      ...
      case 3:
        return 'Ótimo';
      default:
        return nota.toString(); // mantém 4, 5 ou qualquer outro valor
    }
  }
  ...
  void exportarEstatisticas(
    ...
    for (final av in avaliacoes) {
      ...
      // final usuario = av.usuarioId.toString();
      final usuario = av.usuarioId.toString() == 'USR_000123'
          ? 'Usuário não identificado'
          : av.usuarioId.toString();
      final matricula = (av.matricula ?? '').toString();
      final comentario = (av.comentarios ?? '').toString();
      ...
      detalhes.appendRow([
        ...
        excel_lib.TextCellValue(hora),
        excel_lib.TextCellValue(usuario),
        excel_lib.TextCellValue(matricula),
        // excel_lib.IntCellValue(satisfacao),
        // excel_lib.IntCellValue(sabor),
        // excel_lib.IntCellValue(qualidade),
        // excel_lib.IntCellValue(variedade),
        // excel_lib.IntCellValue(atendimento),
        excel_lib.TextCellValue(textoAvaliacao(satisfacao)),
        excel_lib.TextCellValue(textoAvaliacao(sabor)),
        excel_lib.TextCellValue(textoAvaliacao(qualidade)),
        excel_lib.TextCellValue(textoAvaliacao(variedade)),
        excel_lib.TextCellValue(textoAvaliacao(atendimento)),
        excel_lib.TextCellValue(comentario),
      ]);
    }
